...
void YOLO::detect(Mat& frame)
{
    ...
    cout<< "第一步：blob用时: "<<static_cast<double>(end_time_blob-start_time)/CLOCKS_PER_SEC*1000<<"ms"<<endl;//输出运行时间
    ...
    cout<< "第二步：opencv dnn net用时: "<<static_cast<double>(end_time1-end_time_blob)/CLOCKS_PER_SEC*1000<<"ms"<<endl;//输出运行时间
    /////generate proposals
    vector<int> classIds;
    ...
    cout<< "第三步：大循环用时: "<<static_cast<double>(end_time2-end_time1)/CLOCKS_PER_SEC*1000<<"ms"<<endl;//输出运行时间
    ...
    cout<< "第四步NMS用时: "<<static_cast<double>(end_time3-end_time2)/CLOCKS_PER_SEC*1000<<"ms"<<endl;//输出运行时间
    cout<< "总用时: "<<static_cast<double>(end_time3-start_time)/CLOCKS_PER_SEC*1000<<"ms"<<endl;//输出运行时间
}
